function getRating(rating) {
    ...
    res = Array(full_star).fill("<img src='image/star.png'>").join(""); // YULDIZCHA QOYAMAN
    if (0.25 <= rest_star && rest_star <= 0.5) {
        star_count++;
        res += "<img src='image/starHalf.png'>";  // YARIMTALIK YULDIZ
    }
    if (0.5 < rest_star) {
        star_count++;
        res += "<img src='image/emptyStar.png'>"; // BOSH YULDIZ
    }
